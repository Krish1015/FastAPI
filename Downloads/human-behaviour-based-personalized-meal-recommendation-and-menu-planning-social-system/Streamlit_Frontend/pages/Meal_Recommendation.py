...
authenticator = authenticator = stauth.Authenticate(
    config['credentials'],
    config['cookie']['name'],
    config['cookie']['key'],
...
name, authenticatication_status , username = authenticator.login()
authenticator.logout('Logout','sidebar')  
if authenticatication_status == False:
    st.error("Authentication is incorrect")
if authenticatication_status == None:
    st.warning("Please login first")
if authenticatication_status == True:
    ...
    display=Display()
    title=("<h1 style='text-align: center;'> Personalized Meal Recommendation and"
        " Menu Planning System</h1>")
